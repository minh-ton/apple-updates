...
module.exports = function () {
    this.fetch_gdmf = async function (macos, ios, ipados, watchos, audioos, tvos) { // for debugging purposes
        ...
        // Public iOS
        if (ios) await fetch_other_updates(audiences.ios_14_security, "18F72", "D101AP", "iPhone9,3", "14.6", "iOS", "public", false); // iOS 14
        ...
        // Public iPadOS
        if (ipados) await fetch_other_updates(audiences.ios_14_security, "18F72", "J81AP", "iPad5,3", "14.6", "iPadOS", "public", false); // iPadOS 14
